...
namespace IronSimplestServer
{
  class Program
  {
    ...
    {
      Console.Write(@"
Usage:  dotnet IronSimplestServer.dll <service> <private> [key=value]...
...
");
    ...
    {
      Console.WriteLine("IronSimplestServer program started");
      ...
      if (serviceIdentity.ServiceType != "IronSimplest") {
        Console.Error.WriteLine("ERROR - Service described by {0} is of type {1}, not IronSimplest", ps.ServiceFileName,
