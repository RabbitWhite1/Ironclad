...
namespace IronRaftKVClient
{
  public class Client
  {
    ...
    private void Run()
    {
      RaftClient raftClient = new RaftClient(serviceIdentity, "KV", ps.Verbose);
      ...
      for (int requestNum = 1; true; ++requestNum)
      {
        ...
        byte[] replyBytes = raftClient.SubmitRequest(requestBytes);
