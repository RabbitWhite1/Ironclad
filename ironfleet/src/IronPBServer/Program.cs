...
namespace IronPBServer
{
  class Program
  {
    ...
    {
      Console.Write(@"
Usage:  dotnet IronPBServer.dll <service> <private> [key=value]...
...
");
    ...
    {
      Console.WriteLine("IronPBServer program started");
      ...
      if (serviceIdentity.ServiceType != "IronPB") {
        Console.Error.WriteLine("ERROR - Service described by {0} is of type {1}, not IronPB", ps.ServiceFileName,
